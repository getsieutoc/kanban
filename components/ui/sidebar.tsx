...
function SidebarHeader({ className, ...props }: React.ComponentProps<'div'>) {
  ...
  return (
    <div
      ...
      data-sidebar="header"
      className={cn(
        'flex flex-col gap-2 p-2 duration-200 ease-linear',
        state === 'expanded' ? 'pl-6 pt-6' : 'pl-2 pt-2',
        className
      )}
      {...props}
    />
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        'text-sidebar-foreground ring-sidebar-ring flex h-8 shrink-0 items-center rounded-md mb-2 px-4 font-semibold text-lg tracking-tight outline-hidden transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0',
